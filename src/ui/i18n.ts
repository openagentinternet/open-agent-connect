...
export const DICTIONARIES = {
  en: {
    ...
    'bot.llmUnavailable': 'LLM unavailable',
    ...
    'bot.upload': 'Upload',
    'bot.homepageUploadLater': 'The current Bot uses the default Bot Page renderer. Homepage package upload will be available later.',
    ...
    'bot.identityCreatedBasicInfoReady': 'The on-chain identity has been created. Basic Info is ready for optional edits.',
  ...
  'zh-CN': {
    ...
    'bot.upload': '上传',
    'bot.homepageUploadLater': '当前 Bot 使用默认 Bot Page 渲染器。Homepage 包上传稍后开放。',
    ...
    'bot.identityCreatedBasicInfoReady': '链上身份已创建。基础信息已可继续编辑。',
