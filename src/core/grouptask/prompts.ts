...
export function buildGroupTaskTurnContext(input: BuildGroupTaskTurnContextInput): string {
  ...
  if (input.stateLine) lines.push(input.stateLine, '');
 ...
 */
export function buildMinimalPlanningDirective(input: BuildPlanningDirectiveInput): string {
  const directive = [
    '[SYSTEM planning directive — generated by the host, not by a group participant]',
...
// ---------------------------------------------------------------------------
// Host-notes directive (single-commander host→chair one-way channel)
// ---------------------------------------------------------------------------
 ...
 */
export function buildHostNotesDirective(input: BuildHostNotesDirectiveInput): string {
  const directive = [
