...
export function isZipMetaAppContent(contentType: string, contentReference: string): boolean {
...
export function metaAppArchiveUrls(contentReference: string): string[] {
...
export async function downloadMetaAppArchive(
 ...
 */
export async function resolveMetaAppArtifact(input: {
  pinId: string;
  contentReference: string;
  contentType: string;
  indexFile: string;
