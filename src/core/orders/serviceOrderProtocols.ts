...
import { createOrderMetadataLineRegex } from './orderMessage';
...
// Result text may quote metadata lines with markdown bullets/bold and uses a
// few extra chatty labels beyond the canonical order metadata set.
const RESULT_METADATA_LINE_RE = createOrderMetadataLineRegex({
