...
function collectSignals(request: MasterRequestMessage): string {
...
function looksTooVague(request: MasterRequestMessage): boolean {
...
function isDiscoveryEmptyCase(signals: string): boolean {
  return (
    ((signals.includes('master list') || signals.includes('advisor list'))
...
function isSchemaCase(signals: string): boolean {
...
export function runOfficialDebugMaster(input: {
