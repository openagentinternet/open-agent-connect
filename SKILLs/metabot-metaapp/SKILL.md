...
```bash
{{METABOT_CLI}} bot update --from <bot-slug> --payload-file <homepage-payload.json>
```
...
```bash
{{METABOT_CLI}} metaapp new <dir> [--template blank|demo] [--title "My App"] [--app-name my-app]
```
