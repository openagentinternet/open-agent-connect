...
Route every request that reached this skill to the `metabot-browser` skill and follow its rules end to end, including its Connect Ritual and In-App Browser Rule. Do not run `{{METABOT_CLI}} browser open` or `{{METABOT_CLI}} browser tab open` directly from this stub.
