...
```text
Install complete (v0.3.1). `metabot doctor` reports daemon_reachable, and related skills are bound and ready to use.
...
```text
Install complete (v0.3.1). The Open Agent Connect CLI and related skills are installed and bound for this host.
...
```bash
metabot system update --target-version v0.3.1
```
