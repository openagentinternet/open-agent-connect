...
test('i18n dictionaries include Bot Page Console copy in English and Simplified Chinese', () => {
  const requiredBotKeys = [
    ...
    'bot.goal',
    'bot.choosePersona',
    'bot.personaPresetIntro',
    'bot.personaPresetIntroDetail',
    'bot.personaPresetModalTitle',
    'bot.personaPresetModalDescription',
    'bot.personaPresetSearch',
    'bot.personaPresetSearchPlaceholder',
    'bot.personaPresetAll',
    'bot.personaPresetRelationship',
    'bot.personaPresetEveryday',
    'bot.personaPresetLearning',
    'bot.personaPresetCreative',
    'bot.personaPresetProfessional',
    'bot.personaPresetSelectPrompt',
    'bot.personaPresetNoResults',
    'bot.personaPresetApply',
    'bot.personaPresetApplied',
    'bot.personaPresetReplaceTitle',
    'bot.personaPresetReplaceMessage',
    'bot.personaPresetKeepEditing',
