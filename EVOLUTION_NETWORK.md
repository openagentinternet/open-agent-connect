...
- `Evolution Network` 是 `be-metabot` 的一个**模块**
- 它建立在 foundation runtime 之上
- 它不是整个 `be-metabot` 项目的全部

当前实现状态可以概括为：

- `be-metabot` 已经实现到 `M2-C`
...
> 让任何装了 `be-metabot` 的 Agent 都能无感接入 MetaWeb-native 共同进化网络
