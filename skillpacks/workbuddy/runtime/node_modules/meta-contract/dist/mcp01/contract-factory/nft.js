...
class Nft extends ContractAdapter_1.ContractAdapter {
    ...
    // nft
    prevNftInputIndex, prevNftAddress, nftTxHeader, nftTxInputProof, prevNftTxProof, genesisScript,
    // contract
    contractInputIndex, contractTxProof,
    // unlockCheck
    amountCheckHashIndex, amountCheckInputIndex, amountCheckTxProof, amountCheckScrypt,
    // sig
    senderPubKey, senderSig,
    // output
    receiverAddress, nftOutputSatoshis, opReturnScript, changeAddress, changeSatoshis,
    // checkInputIndex,
    // checkScriptTx,
...
class NftFactory {
    ...
    static createContract(unlockContractCodeHashArray, version = 2) {
        return new Nft({
