...
class METALET {
    ...
    getNonFungibleTokenUnspentDetail(codehash, genesis, tokenIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let url = this.serverBase + path;
            let _res = yield net_1.Net.httpGet(url, { tokenIndex }, { headers: this._getHeaders(path) });
            let ret = _res.map((v) => ({
                txId: v.txid,
                outputIndex: v.txIndex,
    ...
    getNftSellUtxo(codehash, genesis, tokenIndex, includesNotReady) {
        return __awaiter(this, void 0, void 0, function* () {
