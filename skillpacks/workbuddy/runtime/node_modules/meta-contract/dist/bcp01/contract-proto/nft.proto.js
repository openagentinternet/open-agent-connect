...
function getNftID(script) {
    return mvc.crypto.Hash.sha256ripemd160(script.slice(script.length - TOKEN_INDEX_OFFSET, script.length - proto.getHeaderLen()));
}
...
function getQueryGenesis(script) {
    return (0, scryptlib_1.toHex)(mvc.crypto.Hash.sha256ripemd160(script.slice(script.length - GENESIS_HASH_OFFSET, script.length - proto.getHeaderLen())));
}
