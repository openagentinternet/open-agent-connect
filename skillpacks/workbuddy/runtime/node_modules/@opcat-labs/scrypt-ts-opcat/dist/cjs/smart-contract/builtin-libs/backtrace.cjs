...
const txHashPreimageUtils_js_1 = require('./txHashPreimageUtils.cjs');
/**
 * Library for verifying backtraces all the way to the genesis point.
 * @category Library
 * @onchain
 */
class Backtrace extends smartContractLib_js_1.SmartContractLib {
    /**
     ...
     */
    static checkPrevTxHashPreimage(txHashPreimage, t_outpoint) {
        const txHash = txHashPreimageUtils_js_1.TxHashPreimageUtils.getTxHashFromTxHashPreimage(txHashPreimage);
        (0, assert_js_1.assert)(txHash == (0, byteString_js_1.slice)(t_outpoint, 0n, 32n), 'prevTxHash mismatch');
    }
    /**
     ...
     */
    static verifyFromOutpoint(backtraceInfo, t_prevOutputIndex, t_genesisOutpoint, t_selfScript, t_prevTxInputList) {
        ...
        if (res.prevPrevOutpoint === t_genesisOutpoint) {
            (0, assert_js_1.assert)(res.prevPrevScript == Backtrace.GENESIS_SCRIPT_HASH, `prevPrevScript does not match Genesis contract script`);
            (0, assert_js_1.assert)(t_prevOutputIndex == 0n, 'prevOutputIndex must be 0 for genesis validation');
        }
        (0, assert_js_1.assert)(res.prevPrevOutpoint == t_genesisOutpoint || res.prevPrevScript == t_selfScript, `can not backtrace to the genesis outpoint`);
    }
    /**
    ...
    static verifyFromScript(backtraceInfo, t_genesisScript, t_selfScript, t_prevTxInputList) {
        const res = Backtrace.verifyChainTxs(backtraceInfo, t_prevTxInputList);
        (0, assert_js_1.assert)(res.prevPrevScript == t_genesisScript || res.prevPrevScript == t_selfScript, `can not backtrace to the genesis script`);
    }
    /**
    ...
    static verifyChainTxs(backtraceInfo, t_prevTxInputList) {
        ...
        (0, assert_js_1.assert)((0, byteString_js_1.slice)(t_prevTxInputList, backtraceInfo.prevTxInputIndex * consts_js_1.TX_INPUT_BYTE_LEN, (backtraceInfo.prevTxInputIndex + 1n) * consts_js_1.TX_INPUT_BYTE_LEN) ==
            txUtils_js_1.TxUtils.mergeInput(backtraceInfo.prevTxInput), 'prevTxInput does not match prevTxInputList at specified index');
        ...
        (0, assert_js_1.assert)(prevPrevTxHash ==
            txHashPreimageUtils_js_1.TxHashPreimageUtils.getTxHashFromTxHashPreimage(backtraceInfo.prevPrevTxPreimage), 'prevPrevTxHash mismatch: prevTxInput.prevTxHash does not match prevPrevTxPreimage hash');
        // all fields in backtraceInfo have been verified
        const prevPrevScript = (0, byteString_js_1.slice)(backtraceInfo.prevPrevTxPreimage.outputList, backtraceInfo.prevTxInput.prevOutputIndex * consts_js_1.TX_OUTPUT_BYTE_LEN + consts_js_1.TX_OUTPUT_SATOSHI_BYTE_LEN, (backtraceInfo.prevTxInput.prevOutputIndex) * consts_js_1.TX_OUTPUT_BYTE_LEN + consts_js_1.TX_OUTPUT_SATOSHI_BYTE_LEN + consts_js_1.TX_OUTPUT_SCRIPT_HASH_LEN);
        const prevPrevOutpoint = prevPrevTxHash + stdUtils_js_1.StdUtils.uint32ToByteString(backtraceInfo.prevTxInput.prevOutputIndex);
 ...
 */
Backtrace.GENESIS_SCRIPT_HASH = (0, byteString_js_1.toByteString)('6712360d7ad09ba9a59cd236aab61db7183c8d881c74ea029debd1f6b26711f8');
__decorate([
    (0, decorators_js_1.prop)(),
    __metadata("design:type", String)
], Backtrace, "GENESIS_SCRIPT_HASH", void 0);
__decorate([
...
__decorate([
    (0, decorators_js_1.method)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, BigInt, String, String, String]),
    __metadata("design:returntype", void 0)
