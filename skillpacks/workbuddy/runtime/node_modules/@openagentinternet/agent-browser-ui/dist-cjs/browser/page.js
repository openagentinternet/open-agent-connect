...
const darkThemeCss_js_1 = require("./darkThemeCss.js");
const indexHtml_js_1 = require("./indexHtml.js");
const metaAppPanelCss_js_1 = require("./metaAppPanelCss.js");
...
async function renderBrowserPageHtml(definition = (0, app_js_1.buildBrowserPageDefinition)(), languagePreference, options) {
    const theme = (0, theme_js_1.normalizeBrowserTheme)(options?.theme);
    ...
    let html = indexHtml_js_1.BROWSER_INDEX_HTML.replace(/<html lang="en">/g, htmlAttributes);
    // Blocking, no-flash theme init at the very top of <head> (before CSS).
    html = replaceTemplateValue(html, '__PAGE_THEME_INIT__', (0, theme_js_1.buildBrowserThemeHeadScript)());
    // Inject component refinements first, then dark-theme overrides keyed off the
    // resolved-theme attribute.
    html = replaceTemplateValue(html, '__PAGE_THEME_CSS__', `${metaAppPanelCss_js_1.BROWSER_METAAPP_PANEL_CSS}\n${darkThemeCss_js_1.BROWSER_DARK_THEME_CSS}`);
