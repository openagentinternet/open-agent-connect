...
HOST_SKILLS_DEST="${METABOT_HOST_SKILL_DEST:-$HOME/.metabot/host-skills/workbuddy}"
...
"$METABOT_BIN" host bind-skills --host workbuddy

echo "Bound host-specific MetaBot skills into the workbuddy host root"
