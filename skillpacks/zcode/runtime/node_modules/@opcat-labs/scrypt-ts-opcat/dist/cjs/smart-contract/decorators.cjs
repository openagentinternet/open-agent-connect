...
exports.tags = exports.TagsMetaKey = exports.prop = exports.PropsMetaKey = exports.method = exports.MethodsMetaKey = void 0;
...
function method(options = {}) {
    ...
    const sigHashType = options.sigHashType ?? 1 /* SigHashType.ALL */;
    ...
    return function (target, methodName, descriptor) {
        ...
        const methods = Reflect.getOwnMetadata(exports.MethodsMetaKey, target) || new Map();
...
function prop() {
    ...
    return function (target, propertyName) {
        const props = (Reflect.getMetadata(exports.PropsMetaKey, target) || []).concat(propertyName);
 ...
 * @ignore
 */
exports.TagsMetaKey = 'scrypt:tags';
/**
