...
library _opcat_labs_scrypt_ts_opcat_4_1_0__rs__ByteStringReader {
  bytes buf;
  int pos;
  ...
  function readBytes() : bytes {
    ...
    if(header < 76) {
        ...
        l = _opcat_labs_scrypt_ts_opcat_4_1_0__rs__StdUtils.fromLEUnsigned(buf[this.pos : this.pos + 1]);
        this.pos += 1;
        ret = this.buf[this.pos : this.pos + l];
      } else if(header == 77) {
        l = _opcat_labs_scrypt_ts_opcat_4_1_0__rs__StdUtils.fromLEUnsigned(this.buf[this.pos : this.pos + 2]);
        this.pos += 2;
        ret = this.buf[this.pos : this.pos + l];
      } else if(header == 78) {
        l = _opcat_labs_scrypt_ts_opcat_4_1_0__rs__StdUtils.fromLEUnsigned(this.buf[this.pos : this.pos + 4]);
        this.pos += 4;
        ret = this.buf[this.pos : this.pos + l];
      } else {
        require(false);
  ...
  function readVarint() : int {
    ...
    return _opcat_labs_scrypt_ts_opcat_4_1_0__rs__StdUtils.fromLEUnsigned(ret);
  }
}