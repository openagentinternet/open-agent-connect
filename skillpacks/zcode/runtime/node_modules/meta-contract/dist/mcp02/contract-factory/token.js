...
class Token extends ContractAdapter_1.ContractAdapter {
    constructor(constuctParams, version = 2) {
    ...
    unlock({ txPreimage, prevouts,
    // token
    tokenInputIndex, prevTokenInputIndex, prevTokenAddress, prevTokenAmount, tokenTxHeader, tokenTxInputProof, prevTokenTxOutputProof,
    // contract
    contractInputIndex, contractTxOutputProof,
    // unlockCheck
    amountCheckHashIndex, amountCheckInputIndex, amountCheckTxOutputProofInfo, amountCheckScript,
    // sig
    senderPubKey, senderSig, operation, }) {
        ...
        // amountCheck
        tokenInputIndex, amountCheckHashIndex, amountCheckInputIndex, amountCheckTxOutputProofInfo, amountCheckScript,
        // token
        prevTokenInputIndex, prevTokenAddress, prevTokenAmount, tokenTxHeader, tokenTxInputProof, prevTokenTxOutputProof,
        // sig data
...
class TokenFactory {
    ...
    static createContract(transferCheckCodeHashArray, unlockContractCodeHashArray, version = 2) {
        return new Token({
