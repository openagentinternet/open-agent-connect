import { API_NET, ApiBase, AuthorizationOption, FungibleTokenBalance, FungibleTokenSummary, FungibleTokenUnspent, NonFungibleTokenSummary, NonFungibleTokenUnspent, SA_utxo } from './index';
export declare class METALET implements ApiBase {
    serverBase: string;
    ...
    getVins(txid: string): Promise<any>;
    /**
     * @param {string} hex
     * @note finished
     */
     ...
     * 查询某人持有的某NFT的UTXO
     */
    getNonFungibleTokenUnspentDetail(codehash: string, genesis: string, tokenIndex: string): Promise<any>;
    /**
    ...
    getNftSellUtxo(codehash: string, genesis: string, tokenIndex: string, includesNotReady?: boolean): Promise<any>;
    ...
    getXpubLiteUtxo(xpub: string): Promise<unknown>;
    getXpubLiteBalance(xpub: string): Promise<unknown>;
}
