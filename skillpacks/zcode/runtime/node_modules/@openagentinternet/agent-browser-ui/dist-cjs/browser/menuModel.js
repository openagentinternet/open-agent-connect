...
exports.BROWSER_BASE_URL_FIELDS = exports.BROWSER_BOT_HOMEPAGE_TEMPLATES = exports.BROWSER_SETTINGS_TABS = exports.BROWSER_MENU_SECTIONS = void 0;
const agent_browser_core_1 = require("@openagentinternet/agent-browser-core");
exports.BROWSER_MENU_SECTIONS = [
    {
        id: 'main',
        items: [
            {
...
const BROWSER_SAFE_TEMPLATE_PREVIEW_IMAGES = {
...
function browserSafeTemplatePreviewImage(previewImage) {
    return BROWSER_SAFE_TEMPLATE_PREVIEW_IMAGES[previewImage] ?? previewImage;
}
exports.BROWSER_BOT_HOMEPAGE_TEMPLATES = agent_browser_core_1.BOT_HOMEPAGE_TEMPLATES.map((template) => ({
    ...template,
    previewImage: browserSafeTemplatePreviewImage(template.previewImage),
}));
exports.BROWSER_BASE_URL_FIELDS = [
    {
