...
exports.safeRendererUrl = safeRendererUrl;
exports.safeResourceUrl = safeResourceUrl;
exports.renderBotPageHtml = renderBotPageHtml;
exports.renderResourceHtml = renderResourceHtml;
const agent_browser_renderers_1 = require("@openagentinternet/agent-browser-renderers");
...
function renderBotPageHtml(resource) {
...
function renderMediaRenderer(renderer, kind) {
...
function renderResourceHtml(resource) {
    ...
    if (renderer.type === 'video')
        return renderMediaRenderer(renderer, 'video');
    if (renderer.type === 'audio')
        return renderMediaRenderer(renderer, 'audio');
    if (renderer.type === 'protocol-pin')
        return (0, agent_browser_renderers_1.renderProtocolPinHtml)(resource);
    if (renderer.type === 'pin-inspector')
        return (0, agent_browser_renderers_1.renderPinInspectorHtml)(resource);
