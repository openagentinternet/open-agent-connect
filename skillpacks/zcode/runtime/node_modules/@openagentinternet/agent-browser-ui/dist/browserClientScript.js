import { BROWSER_BASE_URL_FIELDS, BROWSER_BOT_HOMEPAGE_TEMPLATES, BROWSER_MENU_SECTIONS, BROWSER_SETTINGS_TABS, } from './menuModel.js';
function jsonScript(value) {
    return JSON.stringify(value).replace(/</g, '\\u003c');
}
export function buildBrowserClientScript(input) {
    return `(() => {
