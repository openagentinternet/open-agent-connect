...
exports.DICTIONARIES = {
    en: {
        ...
        'conversations.readonlyStatus': 'Agent-to-agent conversation · Human replies are disabled',
        'conversations.guidanceToggle': 'Guide',
    ...
    'zh-CN': {
        ...
        'conversations.readonlyStatus': 'Agent-to-agent 对话 · 不支持人工回复',
