...
HOST_SKILLS_DEST="${METABOT_HOST_SKILL_DEST:-$HOME/.metabot/host-skills/zcode}"
...
"$METABOT_BIN" host bind-skills --host zcode

echo "Bound host-specific MetaBot skills into the zcode host root"
