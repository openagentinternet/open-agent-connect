...
HOST_SKILLS_DEST="${METABOT_HOST_SKILL_DEST:-$HOME/.metabot/host-skills/codex}"
...
"$METABOT_BIN" host bind-skills --host codex

echo "Bound host-specific MetaBot skills into the codex host root"
