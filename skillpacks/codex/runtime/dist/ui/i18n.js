...
exports.DICTIONARIES = exports.LANGUAGE_STORAGE_KEY = exports.SUPPORTED_CONCRETE_LANGUAGES = exports.SUPPORTED_LANGUAGE_PREFERENCES = exports.DEFAULT_LANGUAGE_PREFERENCE = void 0;
exports.normalizeLanguagePreference = normalizeLanguagePreference;
exports.resolveConcreteLanguage = resolveConcreteLanguage;
exports.translate = translate;
exports.createI18nContext = createI18nContext;
exports.renderLanguageOptions = renderLanguageOptions;
exports.renderClientI18nScript = renderClientI18nScript;
exports.DEFAULT_LANGUAGE_PREFERENCE = 'auto';
exports.SUPPORTED_LANGUAGE_PREFERENCES = ['auto', 'en', 'zh-CN'];
exports.SUPPORTED_CONCRETE_LANGUAGES = ['en', 'zh-CN'];
exports.LANGUAGE_STORAGE_KEY = 'oac.localUi.languagePreference';
...
function normalizeLanguagePreference(value) {
    ...
    return exports.DEFAULT_LANGUAGE_PREFERENCE;
}
function normalizeLocale(value) {
    return typeof value === 'string' ? value.trim().toLowerCase().replace(/_/g, '-') : '';
}
function resolveConcreteLanguage(preference = exports.DEFAULT_LANGUAGE_PREFERENCE, detectedLocales = []) {
...
function translate(language, key, replacements = {}) {
    const template = exports.DICTIONARIES[language]?.[key] ?? exports.DICTIONARIES.en[key] ?? key;
...
function createI18nContext(preference = exports.DEFAULT_LANGUAGE_PREFERENCE, detectedLocales = []) {
    const normalizedPreference = normalizeLanguagePreference(preference);
...
function renderClientI18nScript(i18n) {
    return `(() => {
  const STORAGE_KEY = ${JSON.stringify(exports.LANGUAGE_STORAGE_KEY)};
  const DEFAULT_PREFERENCE = ${JSON.stringify(exports.DEFAULT_LANGUAGE_PREFERENCE)};
  const SERVER_PREFERENCE = ${JSON.stringify(i18n.preference)};
  const DICTIONARIES = ${JSON.stringify(exports.DICTIONARIES)};
