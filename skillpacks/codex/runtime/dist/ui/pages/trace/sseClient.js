...
exports.buildTraceInspectorScript = buildTraceInspectorScript;
const viewModel_1 = require("./viewModel");
function buildTraceInspectorScript() {
    const buildTraceInspectorViewModelSource = viewModel_1.buildTraceInspectorViewModel.toString();
    return `(() => {
