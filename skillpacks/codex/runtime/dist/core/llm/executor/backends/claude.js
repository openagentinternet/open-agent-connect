...
exports.claudeBackendFactory = void 0;
...
function addUsage(target, source) {
    ...
    if (cacheWrite)
        target.cacheWriteTokens = (target.cacheWriteTokens ?? 0) + cacheWrite;
}
...
function createClaudeBackend(binaryPath, env) {
    return {
...
exports.claudeBackendFactory = createClaudeBackend;
