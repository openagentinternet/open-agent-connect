...
```bash
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --file /absolute/path/to/archive.zip --content-type application/zip --chain mvc --verify
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --file /absolute/path/to/archive.zip --content-type application/zip --chain btc --verify
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --file /absolute/path/to/archive.zip --content-type application/zip --chain opcat --verify
```
