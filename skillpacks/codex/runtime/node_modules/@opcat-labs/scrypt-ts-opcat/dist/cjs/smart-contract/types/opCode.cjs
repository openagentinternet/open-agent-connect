 ...
 */
OpCode.OP_0 = (0, primitives_js_1.OpCodeType)('00');
/**
 * An empty array of bytes is pushed onto the stack. (This is not a no-op: an item is added to the stack.)
 * @name OP_FALSE
 * @constant {OpCodeType} `OpCodeType('00')`
 */
OpCode.OP_FALSE = (0, primitives_js_1.OpCodeType)('00');
/**
 * The next byte contains the number of bytes to be pushed onto the stack.
 * @name OP_PUSHDATA1
 * @constant {OpCodeType} `OpCodeType('4c')`
 */
OpCode.OP_PUSHDATA1 = (0, primitives_js_1.OpCodeType)('4c');
/**
 * The next two bytes contain the number of bytes to be pushed onto the stack in little endian order.
 * @name OP_PUSHDATA2
 * @constant {OpCodeType} `OpCodeType('4d')`
 */
OpCode.OP_PUSHDATA2 = (0, primitives_js_1.OpCodeType)('4d');
/**
 * The next four bytes contain the number of bytes to be pushed onto the stack in little endian order.
 * @name OP_PUSHDATA4
 * @constant {OpCodeType} `OpCodeType('4e')`
 */
OpCode.OP_PUSHDATA4 = (0, primitives_js_1.OpCodeType)('4e');
/**
 * The number -1 is pushed onto the stack.
 * @name OP_1NEGATE
 * @constant {OpCodeType} `OpCodeType('4f')`
 */
OpCode.OP_1NEGATE = (0, primitives_js_1.OpCodeType)('4f');
/**
 * Transaction is invalid unless occuring in an unexecuted OP_IF branch
 * @name OP_RESERVED
 * @constant {OpCodeType} `OpCodeType('50')`
 */
OpCode.OP_RESERVED = (0, primitives_js_1.OpCodeType)('50');
/**
 * The number 1 is pushed onto the stack.
 * @name OP_1
 * @constant {OpCodeType} `OpCodeType('51')`
 */
OpCode.OP_1 = (0, primitives_js_1.OpCodeType)('51');
/**
 * The number 1 is pushed onto the stack.
 * @name OP_TRUE
 * @constant {OpCodeType} `OpCodeType('51')`
 */
OpCode.OP_TRUE = (0, primitives_js_1.OpCodeType)('51');
/**
 * The number 2 is pushed onto the stack.
 * @name OP_2
 * @constant {OpCodeType} `OpCodeType('52')`
 */
OpCode.OP_2 = (0, primitives_js_1.OpCodeType)('52');
/**
 * The number 3 is pushed onto the stack.
 * @name OP_3
 * @constant {OpCodeType} `OpCodeType('53')`
 */
OpCode.OP_3 = (0, primitives_js_1.OpCodeType)('53');
/**
 * The number 4 is pushed onto the stack.
 * @name OP_4
 * @constant {OpCodeType} `OpCodeType('54')`
 */
OpCode.OP_4 = (0, primitives_js_1.OpCodeType)('54');
/**
 * The number 5 is pushed onto the stack.
 * @name OP_5
 * @constant {OpCodeType} `OpCodeType('55')`
 */
OpCode.OP_5 = (0, primitives_js_1.OpCodeType)('55');
/**
 * The number 6 is pushed onto the stack.
 * @name OP_6
 * @constant {OpCodeType} `OpCodeType('56')`
 */
OpCode.OP_6 = (0, primitives_js_1.OpCodeType)('56');
/**
 * The number 7 is pushed onto the stack.
 * @name OP_7
 * @constant {OpCodeType} `OpCodeType('57')`
 */
OpCode.OP_7 = (0, primitives_js_1.OpCodeType)('57');
/**
 * The number 8 is pushed onto the stack.
 * @name OP_8
 * @constant {OpCodeType} `OpCodeType('58')`
 */
OpCode.OP_8 = (0, primitives_js_1.OpCodeType)('58');
/**
 * The number 9 is pushed onto the stack.
 * @name OP_9
 * @constant {OpCodeType} `OpCodeType('59')`
 */
OpCode.OP_9 = (0, primitives_js_1.OpCodeType)('59');
/**
 * The number 10 is pushed onto the stack.
 * @name OP_10
 * @constant {OpCodeType} `OpCodeType('5a')`
 */
OpCode.OP_10 = (0, primitives_js_1.OpCodeType)('5a');
/**
 * The number 11 is pushed onto the stack.
 * @name OP_11
 * @constant {OpCodeType} `OpCodeType('5b')`
 */
OpCode.OP_11 = (0, primitives_js_1.OpCodeType)('5b');
/**
 * The number 12 is pushed onto the stack.
 * @name OP_12
 * @constant {OpCodeType} `OpCodeType('5c')`
 */
OpCode.OP_12 = (0, primitives_js_1.OpCodeType)('5c');
/**
 * The number 13 is pushed onto the stack.
 * @name OP_13
 * @constant {OpCodeType} `OpCodeType('5d')`
 */
OpCode.OP_13 = (0, primitives_js_1.OpCodeType)('5d');
/**
 * The number 14 is pushed onto the stack.
 * @name OP_14
 * @constant {OpCodeType} `OpCodeType('5e')`
 */
OpCode.OP_14 = (0, primitives_js_1.OpCodeType)('5e');
/**
 * The number 15 is pushed onto the stack.
 * @name OP_15
 * @constant {OpCodeType} `OpCodeType('5f')`
 */
OpCode.OP_15 = (0, primitives_js_1.OpCodeType)('5f');
/**
 * The number 16 is pushed onto the stack.
 * @name OP_16
 * @constant {OpCodeType} `OpCodeType('60')`
 */
OpCode.OP_16 = (0, primitives_js_1.OpCodeType)('60');
/**
 * Does nothing.
 * @name OP_NOP
 * @constant {OpCodeType} `OpCodeType('61')`
 */
OpCode.OP_NOP = (0, primitives_js_1.OpCodeType)('61');
/**
 ...
 */
OpCode.OP_VER = (0, primitives_js_1.OpCodeType)('62');
/**
 ...
 * ENDIF`
 */
OpCode.OP_IF = (0, primitives_js_1.OpCodeType)('63');
/**
 ...
 * ENDIF`
 */
OpCode.OP_NOTIF = (0, primitives_js_1.OpCodeType)('64');
/**
 * @name OP_VERIF
 * @constant {OpCodeType} `OpCodeType('65')`
 * @deprecated DISABLED
 */
OpCode.OP_VERIF = (0, primitives_js_1.OpCodeType)('65');
/**
 * @name OP_VERNOTIF
 * @constant {OpCodeType} `OpCodeType('66')`
 * @deprecated DISABLED
 */
OpCode.OP_VERNOTIF = (0, primitives_js_1.OpCodeType)('66');
/**
 ...
 * ENDIF`
 */
OpCode.OP_ELSE = (0, primitives_js_1.OpCodeType)('67');
/**
 ...
 * ENDIF`
 */
OpCode.OP_ENDIF = (0, primitives_js_1.OpCodeType)('68');
/**
 * Marks transaction as invalid if top stack value is not true. The top stack value is removed.
 * @name OP_VERIFY
 * @constant {OpCodeType} `OpCodeType('69')`
 */
OpCode.OP_VERIFY = (0, primitives_js_1.OpCodeType)('69');
/**
 ...
 */
OpCode.OP_RETURN = (0, primitives_js_1.OpCodeType)('6a');
/**
 * Puts the input onto the top of the alt stack. Removes it from the main stack.
 * @name OP_TOALTSTACK
 * @constant {OpCodeType} `OpCodeType('6b')`
 */
OpCode.OP_TOALTSTACK = (0, primitives_js_1.OpCodeType)('6b');
/**
 * Puts the input onto the top of the main stack. Removes it from the alt stack.
 * @name OP_FROMALTSTACK
 * @constant {OpCodeType} `OpCodeType('6c')`
 */
OpCode.OP_FROMALTSTACK = (0, primitives_js_1.OpCodeType)('6c');
/**
 * Removes the top two stack items.
 * @name OP_2DROP
 * @constant {OpCodeType} `OpCodeType('6d')`
 */
OpCode.OP_2DROP = (0, primitives_js_1.OpCodeType)('6d');
/**
 * Duplicates the top two stack items.
 * @name OP_2DUP
 * @constant {OpCodeType} `OpCodeType('6e')`
 */
OpCode.OP_2DUP = (0, primitives_js_1.OpCodeType)('6e');
/**
 * Duplicates the top three stack items.
 * @name OP_3DUP
 * @constant {OpCodeType} `OpCodeType('6f')`
 */
OpCode.OP_3DUP = (0, primitives_js_1.OpCodeType)('6f');
/**
 * Copies the pair of items two spaces back in the stack to the front.
 * @name OP_2OVER
 * @constant {OpCodeType} `OpCodeType('70')`
 */
OpCode.OP_2OVER = (0, primitives_js_1.OpCodeType)('70');
/**
 * The fifth and sixth items back are moved to the top of the stack.
 * @name OP_2ROT
 * @constant {OpCodeType} `OpCodeType('71')`
 */
OpCode.OP_2ROT = (0, primitives_js_1.OpCodeType)('71');
/**
 * Swaps the top two pairs of items.
 * @name OP_2SWAP
 * @constant {OpCodeType} `OpCodeType('72')`
 */
OpCode.OP_2SWAP = (0, primitives_js_1.OpCodeType)('72');
/**
 * If the top stack value is not 0, duplicate it.
 * @name OP_IFDUP
 * @constant {OpCodeType} `OpCodeType('73')`
 */
OpCode.OP_IFDUP = (0, primitives_js_1.OpCodeType)('73');
/**
 * Counts the number of stack items onto the stack and places the value on the top
 * @name OP_DEPTH
 * @constant {OpCodeType} `OpCodeType('74')`
 */
OpCode.OP_DEPTH = (0, primitives_js_1.OpCodeType)('74');
/**
 * Removes the top stack item.
 * @name OP_DROP
 * @constant {OpCodeType} `OpCodeType('75')`
 */
OpCode.OP_DROP = (0, primitives_js_1.OpCodeType)('75');
/**
 * Duplicates the top stack item.
 * @name OP_DUP
 * @constant {OpCodeType} `OpCodeType('76')`
 */
OpCode.OP_DUP = (0, primitives_js_1.OpCodeType)('76');
/**
 * Removes the second-to-top stack item.
 * @name OP_NIP
 * @constant {OpCodeType} `OpCodeType('77')`
 */
OpCode.OP_NIP = (0, primitives_js_1.OpCodeType)('77');
/**
 * Copies the second-to-top stack item to the top.
 * @name OP_OVER
 * @constant {OpCodeType} `OpCodeType('78')`
 */
OpCode.OP_OVER = (0, primitives_js_1.OpCodeType)('78');
/**
 * The item `n` back in the stack is copied to the top.
 * @name OP_PICK
 * @constant {OpCodeType} `OpCodeType('79')`
 */
OpCode.OP_PICK = (0, primitives_js_1.OpCodeType)('79');
/**
 * The item `n` back in the stack is moved to the top.
 * @name OP_ROLL
 * @constant {OpCodeType} `OpCodeType('7a')`
 */
OpCode.OP_ROLL = (0, primitives_js_1.OpCodeType)('7a');
/**
 * The top three items on the stack are rotated to the left.
 * @name OP_ROT
 * @constant {OpCodeType} `OpCodeType('7b')`
 */
OpCode.OP_ROT = (0, primitives_js_1.OpCodeType)('7b');
/**
 * The top two items on the stack are swapped.
 * @name OP_SWAP
 * @constant {OpCodeType} `OpCodeType('7c')`
 */
OpCode.OP_SWAP = (0, primitives_js_1.OpCodeType)('7c');
/**
 * The item at the top of the stack is copied and inserted before the second-to-top item.
 * @name OP_TUCK
 * @constant {OpCodeType} `OpCodeType('7d')`
 */
OpCode.OP_TUCK = (0, primitives_js_1.OpCodeType)('7d');
/**
 * Concatenates two strings.
 * @name OP_CAT
 * @constant {OpCodeType} `OpCodeType('7e')`
 */
OpCode.OP_CAT = (0, primitives_js_1.OpCodeType)('7e');
/**
 * Splits byte sequence x at position n.
 * @name OP_SPLIT
 * @constant {OpCodeType} `OpCodeType('7f')`
 */
OpCode.OP_SPLIT = (0, primitives_js_1.OpCodeType)('7f'); // after monolith upgrade (May 2018)
/**
 * Converts numeric value a into byte sequence of length b.
 * @name OP_NUM2BIN
 * @constant {OpCodeType} `OpCodeType('80')`
 */
OpCode.OP_NUM2BIN = (0, primitives_js_1.OpCodeType)('80'); // after monolith upgrade (May 2018)
/**
 * Converts byte sequence x into a numeric value.
 * @name OP_BIN2NUM
 * @constant {OpCodeType} `OpCodeType('81')`
 */
OpCode.OP_BIN2NUM = (0, primitives_js_1.OpCodeType)('81'); // after monolith upgrade (May 2018)
/**
 * Pushes the string length of the top element of the stack (without popping it).
 * @name OP_SIZE
 * @constant {OpCodeType} `OpCodeType('82')`
 */
OpCode.OP_SIZE = (0, primitives_js_1.OpCodeType)('82');
/**
 * Flips all of the bits in the input.
 * @name OP_INVERT
 * @constant {OpCodeType} `OpCodeType('83')`
 */
OpCode.OP_INVERT = (0, primitives_js_1.OpCodeType)('83');
/**
 * Boolean and between each bit in the inputs.
 * @name OP_AND
 * @constant {OpCodeType} `OpCodeType('84')`
 */
OpCode.OP_AND = (0, primitives_js_1.OpCodeType)('84');
/**
 * Boolean or between each bit in the inputs.
 * @name OP_OR
 * @constant {OpCodeType} `OpCodeType('85')`
 */
OpCode.OP_OR = (0, primitives_js_1.OpCodeType)('85');
/**
 * Boolean exclusive or between each bit in the inputs.
 * @name OP_XOR
 * @constant {OpCodeType} `OpCodeType('86')`
 */
OpCode.OP_XOR = (0, primitives_js_1.OpCodeType)('86');
/**
 * Returns 1 if the inputs are exactly equal, 0 otherwise.
 * @name OP_EQUAL
 * @constant {OpCodeType} `OpCodeType('87')`
 */
OpCode.OP_EQUAL = (0, primitives_js_1.OpCodeType)('87');
/**
 * Same as `OP_EQUAL`, but runs `OP_VERIFY` afterward.
 * @name OP_EQUALVERIFY
 * @constant {OpCodeType} `OpCodeType('88')`
 */
OpCode.OP_EQUALVERIFY = (0, primitives_js_1.OpCodeType)('88');
/**
 * Any opcode not assigned is also reserved. Using an unassigned opcode makes the transaction invalid.
 * @name OP_RESERVED1
 * @constant {OpCodeType} `OpCodeType('89')`
 */
OpCode.OP_RESERVED1 = (0, primitives_js_1.OpCodeType)('89');
/**
 * Any opcode not assigned is also reserved. Using an unassigned opcode makes the transaction invalid.
 * @name OP_RESERVED2
 * @constant {OpCodeType} `OpCodeType('8a')`
 */
OpCode.OP_RESERVED2 = (0, primitives_js_1.OpCodeType)('8a');
/**
 * 1 is added to the input.
 * @name OP_1ADD
 * @constant {OpCodeType} `OpCodeType('8b')`
 */
OpCode.OP_1ADD = (0, primitives_js_1.OpCodeType)('8b');
/**
 * 1 is subtracted from the input.
 * @name OP_1SUB
 * @constant {OpCodeType} `OpCodeType('8c')`
 */
OpCode.OP_1SUB = (0, primitives_js_1.OpCodeType)('8c');
/**
 ...
 */
OpCode.OP_2MUL = (0, primitives_js_1.OpCodeType)('8d');
/**
 ...
 */
OpCode.OP_2DIV = (0, primitives_js_1.OpCodeType)('8e');
/**
 * The sign of the input is flipped.
 * @name OP_NEGATE
 * @constant {OpCodeType} `OpCodeType('8f')`
 */
OpCode.OP_NEGATE = (0, primitives_js_1.OpCodeType)('8f');
/**
 * The input is made positive.
 * @name OP_ABS
 * @constant {OpCodeType} `OpCodeType('90')`
 */
OpCode.OP_ABS = (0, primitives_js_1.OpCodeType)('90');
/**
 * If the input is 0 or 1, it is flipped. Otherwise the output will be 0.
 * @name OP_NOT
 * @constant {OpCodeType} `OpCodeType('91')`
 */
OpCode.OP_NOT = (0, primitives_js_1.OpCodeType)('91');
/**
 * Returns 0 if the input is 0. 1 otherwise.
 * @name OP_0NOTEQUAL
 * @constant {OpCodeType} `OpCodeType('92')`
 */
OpCode.OP_0NOTEQUAL = (0, primitives_js_1.OpCodeType)('92');
/**
 * a is added to b.
 * @name OP_ADD
 * @constant {OpCodeType} `OpCodeType('93')`
 */
OpCode.OP_ADD = (0, primitives_js_1.OpCodeType)('93');
/**
 * b is subtracted from a.
 * @name OP_SUB
 * @constant {OpCodeType} `OpCodeType('94')`
 */
OpCode.OP_SUB = (0, primitives_js_1.OpCodeType)('94');
/**
 * a is multiplied by b.
 * @name OP_MUL
 * @constant {OpCodeType} `OpCodeType('95')`
 */
OpCode.OP_MUL = (0, primitives_js_1.OpCodeType)('95');
/**
 * a is divided by b.
 * @name OP_DIV
 * @constant {OpCodeType} `OpCodeType('96')`
 */
OpCode.OP_DIV = (0, primitives_js_1.OpCodeType)('96');
/**
 * Returns the remainder after dividing a by b.
 * @name OP_MOD
 * @constant {OpCodeType} `OpCodeType('97')`
 */
OpCode.OP_MOD = (0, primitives_js_1.OpCodeType)('97');
/**
 * Logical left shift b bits. Sign data is discarded
 * @name OP_LSHIFT
 * @constant {OpCodeType} `OpCodeType('98')`
 */
OpCode.OP_LSHIFT = (0, primitives_js_1.OpCodeType)('98');
/**
 * Logical right shift b bits. Sign data is discarded
 * @name OP_RSHIFT
 * @constant {OpCodeType} `OpCodeType('99')`
 */
OpCode.OP_RSHIFT = (0, primitives_js_1.OpCodeType)('99');
/**
 * If both a and b are not 0, the output is 1. Otherwise 0.
 * @name OP_BOOLAND
 * @constant {OpCodeType} `OpCodeType('9a')`
 */
OpCode.OP_BOOLAND = (0, primitives_js_1.OpCodeType)('9a');
/**
 * If a or b is not 0, the output is 1. Otherwise 0.
 * @name OP_BOOLOR
 * @constant {OpCodeType} `OpCodeType('9b')`
 */
OpCode.OP_BOOLOR = (0, primitives_js_1.OpCodeType)('9b');
/**
 * Returns 1 if the numbers are equal, 0 otherwise.
 * @name OP_NUMEQUAL
 * @constant {OpCodeType} `OpCodeType('9c')`
 */
OpCode.OP_NUMEQUAL = (0, primitives_js_1.OpCodeType)('9c');
/**
 * Same as `OP_NUMEQUAL`, but runs `OP_VERIFY` afterward.
 * @name OP_NUMEQUALVERIFY
 * @constant {OpCodeType} `OpCodeType('9d')`
 */
OpCode.OP_NUMEQUALVERIFY = (0, primitives_js_1.OpCodeType)('9d');
/**
 * Returns 1 if the numbers are not equal, 0 otherwise.
 * @name OP_NUMNOTEQUAL
 * @constant {OpCodeType} `OpCodeType('9e')`
 */
OpCode.OP_NUMNOTEQUAL = (0, primitives_js_1.OpCodeType)('9e');
/**
 * Returns 1 if a is less than b, 0 otherwise.
 * @name OP_LESSTHAN
 * @constant {OpCodeType} `OpCodeType('9f')`
 */
OpCode.OP_LESSTHAN = (0, primitives_js_1.OpCodeType)('9f');
/**
 * Returns 1 if a is greater than b, 0 otherwise.
 * @name OP_GREATERTHAN
 * @constant {OpCodeType} `OpCodeType('a0')`
 */
OpCode.OP_GREATERTHAN = (0, primitives_js_1.OpCodeType)('a0');
/**
 * Returns 1 if a is less than or equal to b, 0 otherwise.
 * @name OP_LESSTHANOREQUAL
 * @constant {OpCodeType} `OpCodeType('a1')`
 */
OpCode.OP_LESSTHANOREQUAL = (0, primitives_js_1.OpCodeType)('a1');
/**
 * Returns 1 if a is greater than or equal to b, 0 otherwise.
 * @name OP_GREATERTHANOREQUAL
 * @constant {OpCodeType} `OpCodeType('a2')`
 */
OpCode.OP_GREATERTHANOREQUAL = (0, primitives_js_1.OpCodeType)('a2');
/**
 * Returns the smaller of a and b.
 * @name OP_MIN
 * @constant {OpCodeType} `OpCodeType('a3')`
 */
OpCode.OP_MIN = (0, primitives_js_1.OpCodeType)('a3');
/**
 * Returns the larger of a and b.
 * @name OP_MAX
 * @constant {OpCodeType} `OpCodeType('a4')`
 */
OpCode.OP_MAX = (0, primitives_js_1.OpCodeType)('a4');
/**
 * Returns 1 if x is within the specified range (left-inclusive), 0 otherwise.
 * @name OP_WITHIN
 * @constant {OpCodeType} `OpCodeType('a5')`
 */
OpCode.OP_WITHIN = (0, primitives_js_1.OpCodeType)('a5');
/**
 * The input is hashed using RIPEMD-160.
 * @name OP_RIPEMD160
 * @constant {OpCodeType} `OpCodeType('a6')`
 */
OpCode.OP_RIPEMD160 = (0, primitives_js_1.OpCodeType)('a6');
/**
 * The input is hashed using SHA-1.
 * @name OP_SHA1
 * @constant {OpCodeType} `OpCodeType('a7')`
 */
OpCode.OP_SHA1 = (0, primitives_js_1.OpCodeType)('a7');
/**
 * The input is hashed using SHA-256.
 * @name OP_SHA256
 * @constant {OpCodeType} `OpCodeType('a8')`
 */
OpCode.OP_SHA256 = (0, primitives_js_1.OpCodeType)('a8');
/**
 * The input is hashed twice: first with SHA-256 and then with RIPEMD-160.
 * @name OP_HASH160
 * @constant {OpCodeType} `OpCodeType('a9')`
 */
OpCode.OP_HASH160 = (0, primitives_js_1.OpCodeType)('a9');
/**
 * The input is hashed two times with SHA-256.
 * @name OP_HASH256
 * @constant {OpCodeType} `OpCodeType('aa')`
 */
OpCode.OP_HASH256 = (0, primitives_js_1.OpCodeType)('aa');
/**
 ...
 */
OpCode.OP_CODESEPARATOR = (0, primitives_js_1.OpCodeType)('ab');
/**
 ...
 */
OpCode.OP_CHECKSIG = (0, primitives_js_1.OpCodeType)('ac');
/**
 * Same as `OP_CHECKSIG`, but `OP_VERIFY` is executed afterward.
 * @name OP_CHECKSIGVERIFY
 * @constant {OpCodeType} `OpCodeType('ad')`
 */
OpCode.OP_CHECKSIGVERIFY = (0, primitives_js_1.OpCodeType)('ad');
/**
 ...
 */
OpCode.OP_CHECKMULTISIG = (0, primitives_js_1.OpCodeType)('ae');
/**
 * Same as `OP_CHECKMULTISIG`, but `OP_VERIFY` is executed afterward.
 * @name OP_CHECKMULTISIGVERIFY
 * @constant {OpCodeType} `OpCodeType('af')`
 */
OpCode.OP_CHECKMULTISIGVERIFY = (0, primitives_js_1.OpCodeType)('af');
/**
 * No operation. The word is ignored.
 * @name OP_NOP1
 * @constant {OpCodeType} `OpCodeType('b0')`
 */
OpCode.OP_NOP1 = (0, primitives_js_1.OpCodeType)('b0');
/**
 * No operation. The word is ignored. (previously OP_CHECKLOCKTIMEVERIFY)
 * @name OP_NOP2
 * @constant {OpCodeType} `OpCodeType('b1')`
 */
OpCode.OP_NOP2 = (0, primitives_js_1.OpCodeType)('b1'); // previously OP_CHECKLOCKTIMEVERIFY
/**
 * No operation. The word is ignored. (previously OP_CHECKSEQUENCEVERIFY)
 * @name OP_NOP3
 * @constant {OpCodeType} `OpCodeType('b2')`
 */
OpCode.OP_NOP3 = (0, primitives_js_1.OpCodeType)('b2');
/**
 * No operation. The word is ignored.
 * @name OP_NOP4
 * @constant {OpCodeType} `OpCodeType('b3')`
 */
OpCode.OP_NOP4 = (0, primitives_js_1.OpCodeType)('b3');
/**
 * No operation. The word is ignored.
 * @name OP_NOP5
 * @constant {OpCodeType} `OpCodeType('b4')`
 */
OpCode.OP_NOP5 = (0, primitives_js_1.OpCodeType)('b4');
/**
 * No operation. The word is ignored.
 * @name OP_NOP6
 * @constant {OpCodeType} `OpCodeType('b5')`
 */
OpCode.OP_NOP6 = (0, primitives_js_1.OpCodeType)('b5');
/**
 * No operation. The word is ignored.
 * @name OP_NOP7
 * @constant {OpCodeType} `OpCodeType('b6')`
 */
OpCode.OP_NOP7 = (0, primitives_js_1.OpCodeType)('b6');
/**
 * No operation. The word is ignored.
 * @name OP_NOP8
 * @constant {OpCodeType} `OpCodeType('b7')`
 */
OpCode.OP_NOP8 = (0, primitives_js_1.OpCodeType)('b7');
/**
 * No operation. The word is ignored.
 * @name OP_NOP9
 * @constant {OpCodeType} `OpCodeType('b8')`
 */
OpCode.OP_NOP9 = (0, primitives_js_1.OpCodeType)('b8');
/**
 * No operation. The word is ignored.
 * @name OP_NOP10
 * @constant {OpCodeType} `OpCodeType('b9')`
 */
OpCode.OP_NOP10 = (0, primitives_js_1.OpCodeType)('b9');
 ...
 */
OpCode.OP_PUBKEYHASH = (0, primitives_js_1.OpCodeType)('fd');
/**
 ...
 */
OpCode.OP_PUBKEY = (0, primitives_js_1.OpCodeType)('fe');
/**
 ...
 */
OpCode.OP_INVALIDOPCODE = (0, primitives_js_1.OpCodeType)('ff');
