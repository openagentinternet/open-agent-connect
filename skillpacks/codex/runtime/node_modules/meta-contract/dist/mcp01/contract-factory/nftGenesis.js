...
class NftGenesis extends ContractAdapter_1.ContractAdapter {
    ...
    prevGenesisTxHeader, prevTxOutputHashProof, prevTxOutputSatoshiBytes, 
    // output
    nftScript, genesisSatoshis, nftSatoshis, changeAddress, changeSatoshis, opReturnScript, }) {
        return this._contract.unlock(txPreimage, pubKey, sig, genesisTxHeader, prevInputIndex, genesisTxInputProof, prevGenesisTxHeader, prevTxOutputHashProof, prevTxOutputSatoshiBytes, nftScript, genesisSatoshis, nftSatoshis, changeAddress, changeSatoshis, opReturnScript);
    }
}
