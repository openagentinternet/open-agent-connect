...
class SensibleFT {
    ...
    _getIssueUtxo(codehash, genesisTxId, genesisOutputIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let genesisUtxos = yield this.api.getFungibleTokenUnspents(codehash, originGenesis, this.zeroAddress.toString());
            ...
            if (!unspent) {
                ...
                let issueUtxos = yield this.api.getFungibleTokenUnspents(codehash, issueGenesis, this.zeroAddress.toString());
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < ftUtxos.length; i++) {
                ...
                if (!curDataPartObj) {
                    ...
                    if (curDataPartObj.rabinPubKeyHashArrayHash != (0, scryptlib_1.toHex)(this.rabinPubKeyHashArrayHash)) {
    ...
    unsignPreTransfer({ codehash, genesis, receivers, senderPublicKey, ftUtxos, ftChangeAddress, utxos, changeAddress, isMerge, opreturnData, middleChangeAddress, minUtxoSet = true, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let unsignTxRaw = JSON.stringify(txComposer.toObject())
                ...
                .replace(new RegExp((0, scryptlib_1.toHex)(Utils.getVarPushdataHeader(routeCheckTxBuf.length)) + (0, scryptlib_1.toHex)(routeCheckTxBuf), 'g'), (0, scryptlib_1.toHex)(Utils.getVarPushdataHeader(Buffer.from(PLACE_HOLDER_UNSIGN_CHECKTX, 'hex').length)) +
    ...
    unsignTransfer(routeCheckTx, unsignTxRaw) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            unsignTxRaw = unsignTxRaw
                ...
                .replace(new RegExp((0, scryptlib_1.toHex)(Utils.getVarPushdataHeader(Buffer.from(PLACE_HOLDER_UNSIGN_CHECKTX, 'hex').length)) + PLACE_HOLDER_UNSIGN_CHECKTX, 'g'), (0, scryptlib_1.toHex)(Utils.getVarPushdataHeader(routeCheckTxBuf.length)) + (0, scryptlib_1.toHex)(routeCheckTxBuf));
    ...
    _transfer({ codehash, genesis, receivers, ftUtxos, ftPrivateKeys, ftChangeAddress, utxos, utxoPrivateKeys, changeAddress, middlePrivateKey, middleChangeAddress, isMerge, opreturnData, minUtxoSet, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (utxos.length > 3) {
                throw new error_1.CodeError(error_1.ErrCode.EC_UTXOS_MORE_THAN_3, 'Mvc utxos should be no more than 3 in the transfer operation, please merge it first ');
            }
            if (!middleChangeAddress) {
            ...
            for (let c = 0; c < 2; c++) {
                ...
                ftUtxoInputIndexs.forEach((inputIndex, idx) => {
                    ...
                    const unlockingContract = tokenContract.unlock({
                        ...
                        senderPubKey: new scryptlib_1.PubKey(ftUtxo.publicKey ? (0, scryptlib_1.toHex)(ftUtxo.publicKey.toBuffer()) : utils_1.PLACE_HOLDER_PUBKEY),
                    ...
                    txComposer.getInput(inputIndex).setScript(unlockingContract.toScript());
                });
    ...
    getBalance({ codehash, genesis, address, }) {
        return __awaiter(this, void 0, void 0, function* () {
            let { balance, pendingBalance } = yield this.api.getFungibleTokenBalance(codehash, genesis, address);
    ...
    getBalanceDetail({ codehash, genesis, address, }) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getFungibleTokenBalance(codehash, genesis, address);
        });
    }
    /**
    ...
    getSummary(address) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getFungibleTokenSummary(address);
        });
    }
    /**
    ...
    getTransferEstimateFee({ codehash, genesis, receivers, senderWif, senderPrivateKey, senderPublicKey, ftUtxos, ftChangeAddress, isMerge, opreturnData, utxoMaxCount = 3, minUtxoSet = true, }) {
        return __awaiter(this, void 0, void 0, function* () {
            let p2pkhInputNum = utxoMaxCount;
            if (p2pkhInputNum > 3) {
                throw new error_1.CodeError(error_1.ErrCode.EC_UTXOS_MORE_THAN_3, 'Mvc utxos should be no more than 3 in the transfer operation. ');
            }
            if (senderWif) {
    ...
    getFtUtxos(codehash, genesis, address, count = 20) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getFungibleTokenUnspents(codehash, genesis, address, count);
        });
    }
    /**
