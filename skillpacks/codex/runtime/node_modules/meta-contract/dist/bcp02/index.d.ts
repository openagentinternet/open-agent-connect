...
import { API_NET, API_TARGET, ApiBase, FungibleTokenUnspent } from '../api';
...
export declare class SensibleFT {
    ...
    unsignTransfer(routeCheckTx: mvc.Transaction, unsignTxRaw: string): Promise<{
        tx: mvc.Transaction;
        sigHashList: SigHashInfo[];
    }>;
    ...
    unsignMerge(routeCheckTx: mvc.Transaction, unsignTxRaw: string): Promise<{
        tx: mvc.Transaction;
        sigHashList: SigHashInfo[];
    }>;
    /**
