...
exports.dumpTx = exports.sign = exports.numberToBuffer = exports.P2PKH_UNLOCK_SIZE = exports.PLACE_HOLDER_PUBKEY = exports.PLACE_HOLDER_SIG = exports.CONTRACT_TYPE = exports.getVarPushdataHeader = exports.isNull = exports.getDustThreshold = exports.sighashType = void 0;
...
function getVarPushdataHeader(n) {
    ...
    if (n == 0) {
        ...
        // Use direct push
        header = (0, mvc_scrypt_1.toHex)(TokenUtil.getUInt8Buf(n));
    }
    else if (n <= 255) {
        header = '4c' + (0, mvc_scrypt_1.toHex)(TokenUtil.getUInt8Buf(n));
    }
    else if (n <= 65535) {
        header = '4d' + (0, mvc_scrypt_1.toHex)(TokenUtil.getUInt16Buf(n));
    }
    else {
        header = '4e' + (0, mvc_scrypt_1.toHex)(TokenUtil.getUInt32Buf(n));
    }
...
function sign(tx, sigHashList, sigList) {
    sigHashList.forEach(({ inputIndex, contractType, sighashType }, index) => {
        ...
        if (contractType == CONTRACT_TYPE.P2PKH) {
            ...
            input.setScript(mvc.Script.buildPublicKeyHashIn(signature.publicKey, signature.signature.toDER(), signature.sigtype));
        }
        else {
            ...
            input.setScript(new mvc.Script(input.script.toHex().replace(oldSigHex, newSigHex).replace(oldPubKeyHex, newPubKeyHex)));
        }
    });
}
exports.sign = sign;
...
=>${index}    ${type == 'standard'
            ...
            : type == 'OP_RETURN'
                ...
                : 'nonstandard' + ' '.repeat(34 - 11)}    ${satoshisToMVC(input.output.satoshis)} MVC
...
=>${index}    ${type == 'standard'
            ...
            : type == 'OP_RETURN'
                ? 'OP_RETURN' + ' '.repeat(34 - 9)
                : 'nonstandard' + ' '.repeat(34 - 11)}    ${satoshisToMVC(output.satoshis)} MVC
