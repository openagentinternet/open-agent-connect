...
class SensibleNFT {
     ...
     */
    constructor({ signers = exports.defaultSignerConfigs, signerSelecteds, feeb = 0.05, network = api_1.API_NET.MAIN, purse, debug = false, apiTarget = api_1.API_TARGET.MVC, apiUrl, mockData, dustLimitFactor = 300, dustAmount, }) {
    ...
    _pretreatUtxos(paramUtxos) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (utxos.length == 0)
                throw new error_1.CodeError(error_1.ErrCode.EC_INSUFFICIENT_MVC, 'Insufficient balance.');
    ...
    _pretreatNftUtxoToTransfer(tokenIndex, codehash, genesis, senderPrivateKey, senderPublicKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let _res = yield this.api.getNonFungibleTokenUnspentDetail(codehash, genesis, tokenIndex);
            let nftUtxo = {
                txId: _res.txId,
    ...
    _pretreatNftUtxoToTransferOn(nftUtxo, codehash, genesis) {
        return __awaiter(this, void 0, void 0, function* () {
            let txHex = yield this.api.getRawTxData(nftUtxo.txId);
            const tx = new mvc.Transaction(txHex);
            ...
            nftUtxo.preNftAddress = mvc.Address.fromPublicKeyHash(Buffer.from(nftProto.getNftAddress(preTx.outputs[preOutputIndex].script.toBuffer()), 'hex'), this.network);
            return nftUtxo;
        });
    }
    /**
    ...
    getIssueUtxo(codehash, genesisTxId, genesisOutputIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let genesisUtxos = yield this.api.getNonFungibleTokenUnspents(codehash, originGenesis, this.zeroAddress.toString());
            ...
            if (!unspent) {
                ...
                let issueUtxos = yield this.api.getNonFungibleTokenUnspents(codehash, issueGenesis, this.zeroAddress.toString());
    ...
    _issue({ genesis, codehash, sensibleId, genesisPrivateKey, genesisPublicKey, receiverAddress, metaTxId, metaOutputIndex, opreturnData, utxos, utxoPrivateKeys, changeAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (balance < estimateSatoshis) {
                throw new error_1.CodeError(error_1.ErrCode.EC_INSUFFICIENT_MVC, `Insufficient balance.It take more than ${estimateSatoshis}, but only ${balance}.`);
            }
            ...
            if (originDataPart.rabinPubKeyHashArrayHash != (0, scryptlib_1.toHex)(this.rabinPubKeyHashArrayHash)) {
    ...
    _transfer({ genesis, codehash, nftUtxo, nftPrivateKey, receiverAddress, opreturnData, utxos, utxoPrivateKeys, changeAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (dataPartObj.rabinPubKeyHashArrayHash != (0, scryptlib_1.toHex)(this.rabinPubKeyHashArrayHash)) {
                throw new error_1.CodeError(error_1.ErrCode.EC_INVALID_SIGNERS, 'Invalid signers.');
            }
            let { rabinDatas, rabinPubKeyIndexArray, rabinPubKeyVerifyArray } = yield (0, satotxSignerUtil_1.getRabinDatas)(this.signers, this.signerSelecteds, [nftUtxo.satotxInfo]);
            const txComposer = new tx_composer_1.TxComposer();
            ...
            for (let c = 0; c < 2; c++) {
                ...
                const unlockingContract = nftContract.unlock({
                    ...
                    genesisScript: nftInput.preNftAddress.hashBuffer.equals(Buffer.alloc(20, 0))
                        ...
                        : new scryptlib_1.Bytes(''),
                    senderPubKey: new scryptlib_1.PubKey(nftInput.publicKey ? (0, scryptlib_1.toHex)(nftInput.publicKey.toBuffer()) : utils_1.PLACE_HOLDER_PUBKEY),
                    ...
                    opReturnScript: new scryptlib_1.Bytes(opreturnScriptHex),
                    changeAddress: new scryptlib_1.Ripemd160((0, scryptlib_1.toHex)(changeAddress.hashBuffer)),
                    changeSatoshis: new scryptlib_1.Int(changeOutputIndex != -1 ? txComposer.getOutput(changeOutputIndex).satoshis : 0),
    ...
    sell({ genesis, codehash, tokenIndex, sellerWif, sellerPrivateKey, satoshisPrice, opreturnData, utxos, changeAddress, noBroadcast = false, middleChangeAddress, middlePrivateKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (nftInfo.nftUtxo.nftAddress.toString() != sellerPublicKey.toAddress(this.network).toString()) {
                throw new error_1.CodeError(error_1.ErrCode.EC_INVALID_ARGUMENT, 'nft seller should be nft owner!');
            }
            let utxoInfo = yield this._pretreatUtxos(utxos);
            if (changeAddress) {
                changeAddress = new mvc.Address(changeAddress, this.network);
    ...
    _sell({ genesis, codehash, tokenIndex, nftUtxo, nftPrivateKey, satoshisPrice, opreturnData, utxos, utxoPrivateKeys, changeAddress, middlePrivateKey, middleChangeAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let { txComposer } = yield this._transfer({
                ...
                nftUtxo,
                nftPrivateKey,
                receiverAddress: new mvc.Address(TokenUtil.getScriptHashBuf(nftSellContract.lockingScript.toBuffer())),
                opreturnData,
                utxos,
                utxoPrivateKeys,
                changeAddress,
    ...
    _sell2({ genesis, codehash, tokenIndex, nftUtxo, satoshisPrice, opreturnData, utxos, utxoPrivateKeys, changeAddress, sellerPublicKey, }) {
        return __awaiter(this, void 0, void 0, function* () {
            if (utxos.length > 3) {
                throw new error_1.CodeError(error_1.ErrCode.EC_UTXOS_MORE_THAN_3, 'Mvc utxos should be no more than 3 in this operation, please merge it first ');
            }
            ...
            let nftSellContract = nftSell_1.NftSellFactory.createContract(new scryptlib_1.Ripemd160((0, scryptlib_1.toHex)(sellerPublicKey.toAddress().hashBuffer)), satoshisPrice, new scryptlib_1.Bytes(codehash), new scryptlib_1.Bytes((0, scryptlib_1.toHex)(nftProto.getNftID(nftUtxo.lockingScript.toBuffer()))));
            nftSellContract.setFormatedDataPart({
                codehash,
                genesis,
                tokenIndex: BN.fromString(tokenIndex, 10),
                sellerAddress: (0, scryptlib_1.toHex)(sellerPublicKey.toAddress().hashBuffer),
                satoshisPrice: BN.fromNumber(satoshisPrice),
                nftID: (0, scryptlib_1.toHex)(nftProto.getNftID(nftUtxo.lockingScript.toBuffer())),
            });
            const txComposer = new tx_composer_1.TxComposer();
            ...
            this._checkTxFeeRate(txComposer);
            let sellAddress = new mvc.Address(TokenUtil.getScriptHashBuf(nftSellContract.lockingScript.toBuffer()), this.network);
    ...
    _cancelSell({ genesis, codehash, nftUtxo, nftPrivateKey, sellUtxo, opreturnData, utxos, utxoPrivateKeys, changeAddress, middlePrivateKey, middleChangeAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let { rabinDatas, checkRabinData, rabinPubKeyIndexArray, rabinPubKeyVerifyArray } = yield (0, satotxSignerUtil_1.getRabinDatas)(this.signers, this.signerSelecteds, [nftUtxo.satotxInfo]);
            const txComposer = new tx_composer_1.TxComposer();
            let prevouts = new Prevouts();
            ...
            // );
            let nftSellContract = nftSell_1.NftSellFactory.createContract(new scryptlib_1.Ripemd160((0, scryptlib_1.toHex)(new mvc.Address(sellUtxo.sellerAddress, this.network).hashBuffer)), sellUtxo.satoshisPrice, new scryptlib_1.Bytes(codehash), new scryptlib_1.Bytes((0, scryptlib_1.toHex)(nftID)));
            ...
            for (let c = 0; c < 2; c++) {
                ...
                txComposer.getInput(nftSellInputIndex).setScript(unlockCall2.toScript());
            }
            if (utxoPrivateKeys && utxoPrivateKeys.length > 0) {
                p2pkhInputIndexs.forEach((inputIndex) => {
                    let privateKey = utxoPrivateKeys.splice(0, 1)[0];
    ...
    _buy({ genesis, codehash, nftUtxo, buyerPrivateKey, sellUtxo, opreturnData, utxos, utxoPrivateKeys, changeAddress, middlePrivateKey, middleChangeAddress, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const unlockCheckInputIndex = txComposer.appendInput(unlockCheckUtxo);
            prevouts.addVout(unlockCheckUtxo.txId, unlockCheckUtxo.outputIndex);
            let sellerAddress = mvc.Address.fromPublicKeyHash(Buffer.from(nftSellContract.constuctParams.senderAddress.value, 'hex'), this.network);
    ...
    getSummary(address) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getNonFungibleTokenSummary(address);
        });
    }
    /**
    ...
    getSummaryDetail(codehash, genesis, address, cursor = 0, size = 20) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getNonFungibleTokenUnspents(codehash, genesis, address, cursor, size);
        });
    }
    /**
    ...
    _calCancelSellEstimateFee({ codehash, nftUtxoSatoshis, nftSellUtxo, genesisScript, opreturnData, utxoMaxCount, }) {
        return __awaiter(this, void 0, void 0, function* () {
            let p2pkhInputNum = utxoMaxCount;
            if (p2pkhInputNum > 3) {
                throw new error_1.CodeError(error_1.ErrCode.EC_UTXOS_MORE_THAN_3, 'Mvc utxos should be no more than 3 in this operation.');
            }
    ...
    _calBuyEstimateFee({ codehash, nftUtxoSatoshis, nftSellUtxo, sellUtxo, genesisScript, opreturnData, utxoMaxCount, }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            //   nftSellUtxo.lockingScript.toASM()
            // );
            let nftSellContract = nftSell_1.NftSellFactory.createContract(new scryptlib_1.Ripemd160((0, scryptlib_1.toHex)(new mvc.Address(sellUtxo.sellerAddress, this.network).hashBuffer)), sellUtxo.satoshisPrice, new scryptlib_1.Bytes(codehash), new scryptlib_1.Bytes(dataPart.nftID));
            nftSellContract.setFormatedDataPart(nftSellProto.parseDataPart(nftSellUtxo.lockingScript.toBuffer()));
    ...
    broadcast(txHex) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.broadcast(txHex);
        });
    }
    /**
     * Print tx
    ...
    _checkTxFeeRate(txComposer) {
        ...
        if (feeRate < this.feeb) {
            throw new error_1.CodeError(error_1.ErrCode.EC_INSUFFICIENT_MVC, `Insufficient balance.The fee rate should not be less than ${this.feeb}, but in the end it is ${feeRate}.`);
        }
    }
    /**
    ...
    isSupportedToken(codehash, sensibleId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let txHex = yield this.api.getRawTxData(genesisTxId);
     ...
     * @returns
     */
    static parseTokenScript(scriptBuf, network = api_1.API_NET.MAIN) {
        if (!(0, protoheader_1.hasProtoFlag)(scriptBuf)) {
            return null;
        }
        const dataPart = nftProto.parseDataPart(scriptBuf);
        const nftAddress = mvc.Address.fromPublicKeyHash(Buffer.from(dataPart.nftAddress, 'hex'), network).toString();
    ...
    getSupplyInfo(sensibleId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let genesisTxHex = yield this.api.getRawTxData(genesisUtxo.txId);
    ...
    getSellList(codehash, genesis, cursor = 0, size = 20) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getNftSellList(codehash, genesis, cursor, size);
        });
    }
    /**
    ...
    getSellListByAddress(address, cursor = 0, size = 20) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.api.getNftSellListByAddress(address, cursor, size);
        });
    }
}
