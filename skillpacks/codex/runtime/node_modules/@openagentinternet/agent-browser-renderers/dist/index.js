export const DEFAULT_PROTOCOL_RENDERERS = [
...
export function renderSimpleBuzzDetail(resource) {
...
export function renderSkillServiceDetail(resource) {
    const body = record(payload(resource));
...
export function renderGenericProtocolPin(resource) {
...
export function renderProtocolPinHtml(resource) {
