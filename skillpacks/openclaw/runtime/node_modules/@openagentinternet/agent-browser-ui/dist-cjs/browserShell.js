...
exports.buildBrowserShellHtml = buildBrowserShellHtml;
const renderers_js_1 = require("./renderers.js");
function buildBrowserShellHtml(input) {
    return `<section class="browser-shell" data-browser-shell>
      <header class="browser-topbar" data-browser-topbar>
        ...
        <form class="browser-address-form" data-browser-address-form>
          <input data-browser-uri-input aria-label="Agent Internet URI" value="${(0, renderers_js_1.escapeHtml)(input.initialUri)}">
...
//# sourceMappingURL=browserShell.js.map