...
function isV3Homepage(homepage) {
...
function v3HasProvenance(homepage) {
...
function resolveHomepageVerificationState(homepage, proofs) {
...
function pickV3Proof(homepage, globalMetaId, state) {
    const profile = recordField(homepage, 'profile');
    const pins = recordField(profile, 'pins');
    const profilePins = [
        ['name', '/info/name'],
...
function buildBotPageResolveResult(input) {
    ...
    return {
        ...
        renderer: {
            ...
            templateId: (0, botHomepageTemplates_js_1.normalizeBotHomepageTemplateId)(input.templateId),
            data: input.homepage,
        },
        status: {
            state: 'resolved',
...
//# sourceMappingURL=botPageResolver.js.map