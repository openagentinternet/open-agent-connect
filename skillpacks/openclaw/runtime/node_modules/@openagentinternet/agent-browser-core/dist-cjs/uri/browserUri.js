...
exports.isValidGlobalMetaId = isValidGlobalMetaId;
exports.parseBrowserUri = parseBrowserUri;
const mapUri_js_1 = require("../browser/mapUri.js");
const metaAppLaunchContext_js_1 = require("../browser/metaAppLaunchContext.js");
const pinUri_js_1 = require("../browser/pinUri.js");
const previewMetaAppUri_js_1 = require("../browser/previewMetaAppUri.js");
const SUPPORTED_SCHEMES = new Set(['metaid', 'metaapp', 'metafile', 'map', 'pin', 'preview-metaapp']);
...
function parseBrowserUri(input) {
    ...
    if (scheme === 'map') {
        const parsed = (0, mapUri_js_1.parseMapUri)(originalUri);
        return {
            originalUri,
    ...
    if (scheme === 'pin') {
        const parsed = (0, pinUri_js_1.parsePinUri)(originalUri);
        return {
            originalUri,
            normalizedUri: parsed.normalizedUri,
            scheme,
    ...
    if (scheme === 'preview-metaapp') {
        const parsed = (0, previewMetaAppUri_js_1.parsePreviewMetaAppUri)(originalUri);
        return {
            originalUri,
            normalizedUri: parsed.normalizedUri,
            scheme,
    ...
    if (scheme === 'metaapp') {
        ...
        const launch = (0, metaAppLaunchContext_js_1.parseMetaAppLaunchUri)(originalUri);
        const launchQuery = (0, metaAppLaunchContext_js_1.serializeMetaAppLaunchQuery)(launch.launchContext);
        return {
            originalUri,
