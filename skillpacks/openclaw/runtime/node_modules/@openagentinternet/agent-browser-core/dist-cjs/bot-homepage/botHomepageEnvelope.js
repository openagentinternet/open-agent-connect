...
exports.buildBotHomepageEnvelope = buildBotHomepageEnvelope;
const botHomepageTemplates_js_1 = require("../templates/botHomepageTemplates.js");
const metafileContentUrl_js_1 = require("../browser/metafileContentUrl.js");
function text(value) {
...
function avatarFromProfile(profile, metafileContentBaseUrl) {
    ...
    return pinId ? (0, metafileContentUrl_js_1.buildMetafileContentUrl)(metafileContentBaseUrl, pinId) : undefined;
}
...
function buildBotHomepageEnvelope(input) {
    ...
    const templateId = (0, botHomepageTemplates_js_1.normalizeBotHomepageTemplateId)(input.templateId, botHomepageTemplates_js_1.DEFAULT_BOT_HOMEPAGE_TEMPLATE_ID);
    return {
        uri: input.uri,
