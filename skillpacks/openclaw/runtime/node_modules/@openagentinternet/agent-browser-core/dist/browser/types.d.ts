...
export type BrowserNameResolutionConfigInput = Omit<Partial<BrowserNameResolutionConfig>, 'ens'> & {
    ens?: BrowserEnsNameResolutionConfigInput;
};
export type BrowserBaseConfigInput = Omit<Partial<BrowserBaseConfig>, 'nameResolution'> & {
