...
import { API_NET, API_TARGET, ApiBase, NonFungibleTokenUnspent } from '../api';
...
export declare class SensibleNFT {
     ...
     * @returns
     */
    getSummary(address: string): Promise<import("../api").NonFungibleTokenSummary[]>;
    /**
     ...
     * @param sigList
     */
    sign(tx: mvc.Transaction, sigHashList: SigHashInfo[], sigList: SigInfo[]): void;
    /**
     ...
     * @param tx
     */
    dumpTx(tx: mvc.Transaction): void;
     ...
     * @returns
     */
    getCodehashAndGensisByTx(genesisTx: mvc.Transaction, genesisOutputIndex?: number): {
        codehash: string;
        genesis: string;
        sensibleId: string;
    };
     ...
     * @returns
     */
    getSellList(codehash: string, genesis: string, cursor?: number, size?: number): Promise<import("../api").NftSellUtxo[]>;
    /**
     ...
     * @returns
     */
    getSellListByAddress(address: string, cursor?: number, size?: number): Promise<import("../api").NftSellUtxo[]>;
}
export {};
