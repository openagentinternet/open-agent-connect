...
function buildAppsPageDefinition(i18n = (0, i18n_1.createI18nContext)()) {
    ...
    `,
        script: buildAppsPageRuntimeSource(runtimeText, {
            codeTypeOptions: [...appsProtocol_1.METAAPP_CODE_TYPE_OPTIONS],
            contentTypeOptions: [...appsProtocol_1.METAAPP_CONTENT_TYPE_OPTIONS],
            metafileReferencePatternSource: appsProtocol_1.METAAPP_METAFILE_REFERENCE_PATTERN.source,
        }),
    };
}
