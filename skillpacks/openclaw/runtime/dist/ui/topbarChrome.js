...
exports.renderTopbarControls = renderTopbarControls;
exports.renderTopbarSettingsModal = renderTopbarSettingsModal;
exports.renderTopbarSettingsScript = renderTopbarSettingsScript;
...
function renderTopbarControls(i18n) {
...
function renderTopbarSettingsModal(i18n) {
...
function renderTopbarSettingsScript() {
    return `(() => {
