export declare const EVOLUTION_ARTIFACT_PROTOCOL_PATH = "/protocols/metabot-evolution-artifact-v1";
export declare const EVOLUTION_ARTIFACT_PROTOCOL_VERSION = "1";
