...
```bash
$HOME/.metabot/bin/metabot metaapp publish-project --project-dir <path> --from <bot-slug> --manifest-file <path>
$HOME/.metabot/bin/metabot metaapp update-project --target-pin-id <pinid> --project-dir <path> --from <bot-slug> --manifest-file <path>
```
