...
```bash
$HOME/.metabot/bin/metabot ui open --page products
```
...
```bash
$HOME/.metabot/bin/metabot identity who --json
$HOME/.metabot/bin/metabot identity list --json
```
...
```bash
$HOME/.metabot/bin/metabot products skills --from <seller-slug> --json
```
...
```bash
$HOME/.metabot/bin/metabot products publish --from <seller-slug> --payload-file <path> [--chain <chain>]
```
...
```bash
$HOME/.metabot/bin/metabot network products --online --query <text> --json
```
...
```bash
$HOME/.metabot/bin/metabot products buy --from <buyer-slug> --request-file <path> --json
```
...
```bash
$HOME/.metabot/bin/metabot products orders list --from <bot-slug> --role <buyer|seller|all> --json
$HOME/.metabot/bin/metabot products orders inspect --from <bot-slug> --product-order-pin-id <pinid> --json
```
