import type { SkillContractPatch, SkillPermissionScope, SkillVariantArtifact as SkillContractVariantArtifact, SkillVariantScopeMetadata, SkillVariantStatus } from '../skills/skillContractTypes';
