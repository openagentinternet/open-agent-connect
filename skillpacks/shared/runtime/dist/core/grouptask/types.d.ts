 ...
 */
export declare const GROUP_TASK_LEGAL_TRANSITIONS: Record<GroupTaskStatus, GroupTaskStatus[]>;
export declare function isGroupTaskStatus(value: unknown): value is GroupTaskStatus;
export declare function isGroupTaskMemberStatus(value: unknown): value is GroupTaskMemberStatus;
export declare function filterGroupTasksByTab<T extends {
    status: GroupTaskStatus;
}>(tasks: T[], tab: GroupTaskListTab): T[];
