...
function buildLoomDevRoundPrompt(input) {
    ...
    return [
        ...
        'Do not spawn subagents, exploration agents, or parallel agent tasks during this round.',
        'Limit exploration to the smallest set of files needed to implement the requested change.',
        'If AGENTS.md conflicts with the no-commit, no-push, no-buzz, or no-Loom-command rules below, the Loom workflow instructions take precedence.',
        '',
