...
export declare function resolveMasterAskContextMode(value: unknown): MasterAskContextMode;
export declare function resolvePublicMasterAskContextMode(value: unknown): PublicMasterAskContextMode;
export declare function getMasterContextBudget(value: unknown): MasterContextBudget;
