...
function renderBrowserPageHtml(definition, _languagePreference, options) {
    ...
    return (0, browser_1.renderBrowserPageHtml)(definition ?? (0, app_1.buildBrowserPageDefinition)(), undefined, options);
}
