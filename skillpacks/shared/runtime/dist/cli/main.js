...
const products_1 = require("./commands/products");
        ...
        if (versionRequested(argv)) {
            ...
            switch (command) {
                ...
                case 'bot':
                    ...
                    break;
                case 'browser':
                    result = await (0, browser_1.runBrowserCommand)(rest, context);
                    break;
                case 'chain':
                ...
                case 'provider':
                    ...
                    break;
                case 'products':
                    result = await (0, products_1.runProductsCommand)(rest, context);
                    break;
                case 'services':
