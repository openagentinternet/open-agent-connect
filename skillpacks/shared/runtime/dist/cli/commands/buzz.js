...
exports.runBuzzCommand = runBuzzCommand;
...
function resolveAttachmentPaths(baseDir, value) {
...
async function runBuzzCommand(args, context) {
    ...
    if (!handler) {
        return (0, commandResult_1.commandFailed)('not_implemented', 'Buzz post handler is not configured.');
    }
