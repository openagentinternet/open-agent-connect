...
export default class CreateNoteCommand {
  constructor(options = {}) {
    ...
    try {
      ...
      var baseExisting = Array.isArray(payload.existingAttachments)
        ...
        : Array.isArray(form.attachments)
          ? form.attachments
          : (editorStore && Array.isArray(editorStore.existingAttachments) ? editorStore.existingAttachments : []);
      ...
      return { pinRes: pinRes, noteData: finalNoteData };
    } catch (error) {
