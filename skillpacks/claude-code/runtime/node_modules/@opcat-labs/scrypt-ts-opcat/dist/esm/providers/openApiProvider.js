...
export class OpenApiProvider {
    ...
    async getUtxos(address, _options) {
        ...
        while (true) {
            ...
            if (contentType?.includes('json')) {
                ...
                if (requiredSat > 0 && totalSatoshis >= requiredSat)
                    break;
            }
            else {
    ...
    async getRawTransaction(txId) {
        ...
        if (!txHex) {
            ...
            if (res instanceof Error) {
                throw new Error(`Can not find the tx with id ${txId}, please broadcast it by using the OpenApiProvider first`);
            }
            txHex = res;
        }
        return txHex;
