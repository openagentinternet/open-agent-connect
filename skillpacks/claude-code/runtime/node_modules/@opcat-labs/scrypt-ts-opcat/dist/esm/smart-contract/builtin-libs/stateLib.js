 ...
 * @onchain
 */
export class StateLib extends SmartContractLib {
    /**
    ...
    static serializeState(state) {
        ...
        const library = abiCoder.artifact.library.find((lib) => getUnRenamedSymbol(lib.name) === getUnRenamedSymbol(this.name));
        if (!library) {
