import { KeyValue, PsbtGlobalUpdate, PsbtInput, PsbtInputUpdate, PsbtOutput, PsbtOutputUpdate, Psbt as PsbtBase } from 'bip174';
import { Transaction, Network } from '@opcat-labs/opcat';
...
export declare class Psbt {
    ...
    addOutput(outputData: PsbtOutputExtended & {
        opcatOutputData?: Uint8Array;
    }): this;
    ...
    private _setOpcatKV;
    private _restoreTxOutputData;
    private _assertOpcatPsbt;
    toBuffer(): Uint8Array;
    toHex(): string;
    toBase64(): string;
...
type AllScriptType = 'pubkeyhash' | 'multisig' | 'pubkey' | 'nonstandard';
export {};
