...
function getRabinDataEmpty(signers, signerSelecteds) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let rabinSigArray = [];
        rabinMsg = new mvc_scrypt_1.Bytes('');
        signerSelecteds.forEach((v) => {
            rabinPaddingArray.push(new mvc_scrypt_1.Bytes(''));
            rabinSigArray.push(new mvc_scrypt_1.Int(0));
        });
        let rabinPubKeyIndexArray = signerSelecteds;
        let rabinPubKeyVerifyArray = [];
        rabinPubKeyIndexArray.forEach((signerIndex) => {
            rabinPubKeyVerifyArray.push(new mvc_scrypt_1.Int(signers[signerIndex].satotxPubKey.toString(10)));
        });
        return {
            rabinData: {
                rabinMsg,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!rabinUtxo) {
            ...
            for (let j = 0; j < sigReqArray.length; j++) {
                ...
                if (j == 0) {
                    rabinMsg = new mvc_scrypt_1.Bytes(sigInfo.payload);
                }
                rabinSigArray.push(new mvc_scrypt_1.Int(BN.fromString(sigInfo.sigBE, 16).toString(10)));
                rabinPaddingArray.push(new mvc_scrypt_1.Bytes(sigInfo.padding));
            }
        }
        rabinPubKeyIndexArray.forEach((signerIndex) => {
            rabinPubKeyVerifyArray.push(new mvc_scrypt_1.Int(signers[signerIndex].satotxPubKey.toString(10)));
...
function getRabinDatas(signers, signerSelecteds, rabinInputs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < sigReqArray.length; i++) {
            for (let j = 0; j < sigReqArray[i].length; j++) {
                ...
                if (j == 0) {
                    ...
                    checkRabinData.rabinMsg = new mvc_scrypt_1.Bytes(sigInfo.byTxPayload);
                }
                ...
                checkRabinData.rabinSigArray.push(new mvc_scrypt_1.Int(BN.fromString(sigInfo.byTxSigBE, 16).toString(10)));
                checkRabinData.rabinPaddingArray.push(new mvc_scrypt_1.Bytes(sigInfo.byTxPadding));
            }
        }
        ...
        return {
            rabinDatas,
            checkRabinDatas: {
                rabinMsgArray: new mvc_scrypt_1.Bytes((0, mvc_scrypt_1.toHex)(checkRabinMsgArray)),
                rabinPaddingArray: new mvc_scrypt_1.Bytes((0, mvc_scrypt_1.toHex)(checkRabinPaddingArray)),
                rabinSigArray: new mvc_scrypt_1.Bytes((0, mvc_scrypt_1.toHex)(checkRabinSigArray)),
            },
            checkRabinData,
            rabinPubKeyIndexArray,
            rabinPubKeyVerifyArray,
