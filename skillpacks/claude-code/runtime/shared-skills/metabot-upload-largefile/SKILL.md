...
```bash
$HOME/.metabot/bin/metabot file upload-large --request-file request.json
```

With an actor:

```bash
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --request-file request.json
```
...
```bash
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --request-file request.json --chain mvc
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --request-file request.json --chain btc
$HOME/.metabot/bin/metabot file upload-large --from <bot-slug> --request-file request.json --chain opcat
```
