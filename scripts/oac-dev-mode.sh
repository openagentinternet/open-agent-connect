...
RESTART_DAEMON=0
SKIP_BUILD=0
SUPPORTED_HOSTS="claude-code|codex|copilot|opencode|openclaw|hermes|gemini|pi|cursor|kimi|kiro|codebuddy|zcode|workbuddy"

usage() {
  cat <<'USAGE'
Usage: scripts/oac-dev-mode.sh [--host <claude-code|codex|copilot|opencode|openclaw|hermes|gemini|pi|cursor|kimi|kiro|codebuddy|zcode|workbuddy>] [--restart-daemon] [--skip-build]
...
case "$HOST" in
  claude-code|codex|copilot|opencode|openclaw|hermes|gemini|pi|cursor|kimi|kiro|codebuddy|zcode|workbuddy)
    ;;
  *)
